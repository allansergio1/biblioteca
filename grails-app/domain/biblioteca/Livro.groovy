...
class Livro {
    ...
    static belongsTo = [autor: Autor] // Um livro pertence a um autor
    static hasMany = [categorias: Categoria] // Um livro pode ter vários autores e categorias
    ...
    static constraints = {
        ...
        ano blank: false // O ano deve estar entre 1900 e 2023
